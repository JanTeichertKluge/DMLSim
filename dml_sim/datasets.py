...
def make_plr_fingerhut2018(
    n_obs=500, dim_x=20, theta=1, return_type="DoubleMLData", **kwargs
):
    """
    ...
    **kwargs : dict
    ...
    d = m0 + np.random.standard_normal(
        size=[
            n_obs,
        ]
    )
...
def make_irm_farell2021(n_obs=500, dim_x=20, return_type="DoubleMLData", **kwargs):
    ...
    **kwargs : dict
    ...
    d = np.random.binomial(size=n_obs, n=1, p=prob_of_d).reshape(
        n_obs,
    )
