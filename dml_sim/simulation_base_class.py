        ...
        for self._n_obs_act in self.np_dict["n_obs"]:
            for self._dim_x_act in self.np_dict["dim_x"]:
                ...
                for lvl_lrn_dict in self.lrn_dict.keys():
                    ...
                    self._model_cache = {
                        attr: np.empty(shape=(self.n_rep,)) for attr in self._model_attr
                    }
                    ...
                    self.model_attr["theta_dml"][self._lrn_act][
                        indx
                    ] = self._model_cache["theta_dml"]
                    self.model_attr["se_dml"][self._lrn_act][indx] = self._model_cache[
                        "se_dml"
                    ]
                    self.model_attr["lowCI"][self._lrn_act][indx] = self._model_cache[
                        "lowCI"
                    ]
                    self.model_attr["upCI"][self._lrn_act][indx] = self._model_cache[
                        "upCI"
                    ]
                    self._i_rep = 0
                print("\n")
